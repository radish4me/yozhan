...
case "${LOCAL_DEFAULT_MODEL:-qwen3.5-0.8b}" in
  qwen3.5-0.8b)   HF_REF="unsloth/Qwen3.5-0.8B-GGUF:Q4_K_M" ;;
  lfm2.5)         HF_REF="LiquidAI/LFM2.5-1.2B-Instruct-GGUF:Q4_K_M" ;;
  agents-a1-4b)   HF_REF="InternScience/Agents-A1-4B-Q4_K_M-GGUF:Q4_K_M" ;;
